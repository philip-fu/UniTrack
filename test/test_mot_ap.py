    ...
    for frame_id, (img, obs, img0, _) in enumerate(dataloader):
        ...
        if show_image or save_dir is not None:
            online_im = vis.plot_tracking(
                    img0, online_tlwhs, online_ids, frame_id=frame_id + 1,
...
if __name__ == '__main__':
    ...
    data_root = '{}/images/{}'.format(opt.mot_root, opt.data_set_type)
    seqs = os.listdir(data_root) if len(opt.seqs) == 0 else opt.seqs
